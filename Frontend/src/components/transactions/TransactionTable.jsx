    ...
    <div className="bg-white p-4 rounded shadow overflow-x-auto">
      ...
      >
        ...
        >
          ...
          <div className="flex flex-col gap-3">
            ...
            >
              <option value="expense" className="bg-amber-50">
                Expense
              </option>
              <option value="income" className="bg-amber-50">
                Income
              </option>
            </select>
      ...
      <table className="w-full text-center border-separate border-spacing-y-2">
        ...
        <tbody>
          {filtered.length > 0 ? (
            filtered.map((t) => (
              <tr className="bg-gray-200" key={t.id}>
                <td>{t.date}</td>
                <td>₹{t.amount}</td>
                <td>{t.category}</td>
                <td>{t.type}</td>
                <td>
                  <button
                    ...
                    className="mr-2 px-2 rounded-md bg-green-300 cursor-pointer"
                  >
                    Edit
                  </button>
                  <button
